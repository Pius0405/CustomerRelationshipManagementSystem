...
$_SESSION['intrBackTo'] = 'cust-interaction.php';
...
$_SESSION["currentIntr"] = "c";
$stmt = $conn -> prepare("SELECT * FROM customerinteraction WHERE user_id = ? AND customer_id = ?");
$stmt -> bind_param("ii", $_SESSION["userID"], $_SESSION["customerIntrID"]);
$stmt -> execute();
